...
def curriculum_1(sim):
    ...
    # Disable Klask and Two Biscuit terminal conditions
    # -1 reward for each episode that the puck doesn't hit the ball
...
def reward_to_p1(game_states, sim, curriculum_step):
    reward = 0.0
    terminated = False
    ...
    if sim != None and curriculum_step != None:
        ...
        if curriculum_step == 1:
            terminated, reward = curriculum_1(sim)
